...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      <main className="flex-grow flex flex-col">
        ...
        <section className="bg-white dark:bg-gray-800 py-16 px-4 text-center">
          <div className="container mx-auto">
            <h1 className="text-4xl font-bold text-green-700 dark:text-green-400 mb-4">SproutBotanica</h1>
        ...
        <section className="bg-gray-100 dark:bg-gray-700 py-16 px-4">
          <div className="container mx-auto">
            <h2 className="text-3xl font-bold text-green-700 dark:text-green-400 mb-12 text-center">Our Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { icon: Leaf, title: "Plant Identification", description: "Instantly identify any plant species by simply taking a photo. Our AI-powered system provides accurate results within seconds.", color: "text-green-600 dark:text-green-400" },
                { icon: AlertTriangle, title: "Disease Detection", description: "Detect plant diseases early. Upload a photo of your plant, and our system will diagnose potential issues and suggest treatments.", color: "text-yellow-600 dark:text-yellow-400" },
                { icon: ShoppingBag, title: "E-commerce", description: "Shop for plants, tools, and accessories directly through our app. We partner with trusted suppliers to bring you quality products.", color: "text-blue-600 dark:text-blue-400" },
                { icon: BarChart2, title: "Growth Tracking", description: "Monitor your plants' growth over time. Set care reminders, log watering and fertilizing, and watch your garden flourish.", color: "text-purple-600 dark:text-purple-400" },
                { icon: MessageSquare, title: "Chat with BOT", description: "Get instant answers to your plant care questions. Our AI chatbot provides expert advice 24/7, helping you become a better gardener.", color: "text-indigo-600 dark:text-indigo-400" },
              ].map((feature, index) => (
                <Card key={index} className="rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 bg-[url('/placeholder.svg?height=200&width=200')] bg-opacity-10 dark:bg-opacity-30 border-2 border-green-600 dark:border-green-400 rounded-xl p-10 max-w-4xl mx-auto shadow-xl transform hover:scale-105 transition-all duration-300 mt-16">
          <div className="bg-gradient-to-r from-green-400 to-green-600 dark:from-green-600 dark:to-green-800 text-white py-3 px-6 rounded-lg -mt-14 mb-6 shadow-lg inline-block">
      ...
      <footer className="bg-green-600 dark:bg-green-800 text-white py-4 mt-16">
